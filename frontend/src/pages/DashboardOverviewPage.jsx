    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-yellow-100 p-4 rounded-lg text-center">
          <p className="text-4xl font-bold text-yellow-800">{stats.upcomingSessionCount}</p>
          <p className="text-yellow-600 font-semibold">Anstehende Sessions</p>
        </div>

        {/* GEÄNDERT: Karte für vergangene Sessions */}
        <div className="bg-green-100 p-4 rounded-lg text-center">
          <p className="text-4xl font-bold text-green-800">{stats.pastSessionCount}</p>
          <p className="text-green-600 font-semibold">Vergangene Sessions</p>
        </div>
      </div>
    </div>
  );
